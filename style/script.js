...
const texts = [
 ...
 setTimeout(() => {
  ...
  // Khi click vào ảnh → hiện bài thơ
  img.addEventListener("click", () => {
    // Ngăn không tạo lại nếu đã tạo rồi
    if (document.getElementById("poemBox")) return;
    ...
    // Khi click vào bài thơ → hiện lời chúc
    poem.addEventListener("click", () => {
      if (document.getElementById("wishBox")) return;
...
}, texts.length * 3000); // Sau hiệu ứng text mới hiện ảnh
